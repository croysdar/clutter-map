...
public class ItemRepositoryIntegrationTests {
    ...
    void findByOwner_ShouldReturnOnlyItemsOwnedBySpecifiedUser() {
        ...
        Item item1 = new Item("Item Owned by Owner 1", "Item Description", List.of("tag 1"), orgUnit1, 1);
        Item item2 = new Item("Item Owned by Owner 2", "Item Description", List.of("tag 2"), orgUnit2, 1);
    ...
    void findByOwner_ShouldReturnAllItemsOwnedByUser() {
        ...
        Item item1 = new Item("Item 1", "Item Description", List.of("tag 1"), orgUnit, 1);
        Item item2 = new Item("Item 2", "Item Description", List.of("tag 1"), orgUnit, 1);
        Item item3 = new Item("Item 3", "Item Description", List.of("tag 1"), orgUnit, 1);
